# Yadav Interior — Interior Designing & Discovery Platform

[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy)

This repository contains the full-stack Laravel platform for showcasing interior designers, client inquiries, and portfolio case studies.

**Production Deployment Guides**: See [DEPLOYMENT.md](DEPLOYMENT.md) for full instructions on deploying the backend to **Render** and the application/frontend to **Vercel**.

**Important files:** [render.yaml](render.yaml), [vercel.json](vercel.json), [Dockerfile](Dockerfile), [DEPLOYMENT.md](DEPLOYMENT.md), [docker-compose.yml](docker-compose.yml)
