...
Route::middleware(['auth', 'designer'])->prefix('dashboard')->name('dashboard.')->group(function () {
    ...
    Route::post('/inquiries/{inquiry}/replies', [DashboardInquiryController::class, 'reply'])->name('inquiries.reply');
});

Route::middleware(['auth', 'client'])->prefix('client')->name('client.')->group(function () {
    Route::get('/dashboard', [ClientDashboardController::class, 'index'])->name('dashboard');
    Route::put('/profile', [ClientDashboardController::class, 'update'])->name('profile.update');
    Route::post('/inquiries/{inquiry}/replies', [ClientDashboardController::class, 'reply'])->name('inquiries.reply');
});
